...
let _state = {
  /**@type {BgImage} */
  bgimage: new BgImage({url: 'https://splashbase.s3.amazonaws.com/splitshire/regular/SplitShire-London-Collection-210080-768x506.jpg'}),
  /**@type {Quote} */
  quote: new Quote({quote: {body: "some quote"}, quote: {author: "some author"}}), //i made temp fake data
  /**@type {Weather} */
